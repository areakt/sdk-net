...
public record Duration
{
    ...
    public virtual double TotalDays => TotalHours / 24;

    /// <summary>
    /// Gets the the duration's total amount of hours
    /// </summary>
    [IgnoreDataMember, JsonIgnore, YamlIgnore]
    public virtual double TotalHours => TotalMinutes / 60;

    /// <summary>
    /// Gets the the duration's total amount of minutes
    /// </summary>
    [IgnoreDataMember, JsonIgnore, YamlIgnore]
    public virtual double TotalMinutes => TotalSeconds / 60;

    /// <summary>
    /// Gets the the duration's total amount of seconds
    /// </summary>
    [IgnoreDataMember, JsonIgnore, YamlIgnore]
    public virtual double TotalSeconds => TotalMilliseconds / 1000;
    ...
    public virtual TimeSpan ToTimeSpan() => new((int)(Days ?? 0), (int)(Hours ?? 0), (int)(Minutes ?? 0), (int)(Seconds ?? 0), (int)(Milliseconds ?? 0));
